...
export default function AdminPackagesPage() {
  ...
  return (
    <>
      <h1 className="text-2xl font-bold text-black pt-4">Gestione Pacchetti</h1>
        ...
        {items.map((p, i) => (
          <div key={p.id ?? i} className="bg-card border border-border rounded-lg p-6 shadow-sm">
            ...
            <div className="flex items-center justify-between mb-4">
               <h3 className="text-lg font-semibold text-black">Pacchetto {i + 1}</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <h4 className="font-medium text-black border-b pb-2">Informazioni Base</h4>
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-black">Descrizione *</label>
                  <textarea 
                    className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-black placeholder:text-black/70" 
                    rows={3} 
                    value={p.description} 
            ...
            <div>
              ...
              <div className="space-y-4">
                <h4 className="font-medium text-black border-b pb-2">Prezzi e Opzioni</h4>
            ...
            <div className="mt-6 border-t pt-6">
              <h4 className="font-medium text-black mb-4">Dettagli del Pacchetto</h4>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1 text-black">Note Aggiuntive</label>
                    <textarea 
                      className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-black placeholder:text-black/70" 
                      rows={3} 
                ...
                <div className="space-y-4">
                  {/* Caratteristiche */}
                  <div>
                    <label className="block text-sm font-medium mb-2 text-black">Caratteristiche/Benefici</label>
                    <div className="space-y-2">
                  ...
                  {/* Cosa è incluso */}
                  <div>
                    <label className="block text-sm font-medium mb-2 text-black">Cosa è Incluso</label>
                    <div className="space-y-2">
                  ...
                  {/* Requisiti */}
                  <div>
                    <label className="block text-sm font-medium mb-2 text-black">Requisiti</label>
                    <div className="space-y-2">
